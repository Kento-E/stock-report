...
目次の売買判断列では、判断内容に応じて視覚的な強調表示を行い、重要な情報を見やすくします：

- **売り判断**: 赤字（#dc3545）+ 太字で表示し、損切りが必要な銘柄を目立たせる
- **ホールド判断**: 通常フォント（太字なし）で表示し、緊急性の低さを視覚的に示す
- **買い判断**: 太字で表示し、購入機会を強調
- **買い増し判断**: 太字で表示し、追加購入機会を強調
- **様子見判断**: 通常フォント（太字なし）で表示し、緊急性の低さを視覚的に示す

この視覚的な区別により、長いリストでも重要な売買判断を素早く識別できます。
...
両者とも緊急性が低いため、目次では通常フォントで表示され、アクションが必要な判断（買い/売り）と視覚的に区別されます。
