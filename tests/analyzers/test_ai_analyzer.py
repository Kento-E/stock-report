...
class TestGenerateHoldingStatus:
    ...
    def test_holding_status_with_profit(self):
        """保有中で利益が出ている場合"""
        data = {"quantity": 100, "acquisition_price": 2500, "price": 2700, "account_type": "特定"}
        currency = "円"
    ...
    def test_holding_status_with_loss(self):
        """保有中で損失が出ている場合"""
        data = {"quantity": 100, "acquisition_price": 2700, "price": 2500, "account_type": "特定"}
        currency = "円"
    ...
    def test_short_selling_status(self):
        """空売り中の場合"""
        data = {"quantity": -50, "acquisition_price": 12000, "price": 11500, "account_type": "NISA"}
        currency = "円"
    ...
    def test_holding_without_acquisition_price(self):
        """取得単価が未設定の場合"""
        data = {"quantity": 100, "price": 2500, "account_type": "特定"}
        currency = "円"
    ...
    def test_currency_dollar(self):
        """通貨がドルの場合"""
        data = {"quantity": 50, "acquisition_price": 150, "price": 160, "account_type": "特定"}
        currency = "ドル"
    ...
    def test_currency_euro(self):
        """通貨がユーロの場合"""
        data = {"quantity": 30, "acquisition_price": 80, "price": 85, "account_type": "特定"}
        currency = "ユーロ"
    ...
    def test_currency_pound(self):
        """通貨がポンドの場合"""
        data = {"quantity": 100, "acquisition_price": 650, "price": 670, "account_type": "特定"}
        currency = "ポンド"
    ...
    def test_tax_calculation_nisa_account(self):
        """NISA口座は非課税"""
        data = {"quantity": 100, "acquisition_price": 2500, "price": 2700, "account_type": "NISA"}
        currency = "円"
    ...
    def test_tax_calculation_old_nisa_account(self):
        """旧NISA口座は非課税"""
        data = {"quantity": 100, "acquisition_price": 2500, "price": 2700, "account_type": "旧NISA"}
        currency = "円"
    ...
    def test_short_selling_with_tax(self):
        """空売りで利益が出た場合の税額計算"""
        data = {"quantity": -50, "acquisition_price": 12000, "price": 11500, "account_type": "特定"}
        currency = "円"
...
class TestAnalysisViewpointsSelection:
    ...
    def test_short_viewpoints_no_regular_terms(self):
        ...
        judgment_section = [
            line for line in lines if "・" in line or "買い" in line or "売り" in line
        ]

        # 判断リストに「買戻し」はあるが単純な「・買い」はない
        has_buyback = any("買戻し" in line for line in judgment_section)
        has_simple_buy = any(
            "・買い" in line and "買戻し" not in line and "買い増し" not in line
            for line in judgment_section
        )
